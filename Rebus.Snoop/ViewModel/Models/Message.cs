...
#pragma warning restore 649
        ...
        {
            get { return Headers.Where(h => h.Key != Messages.Headers.ErrorDetails).ToArray(); }
        }
        ...
        public string ErrorDetails
        {
            get
            {
                return Headers.ContainsKey(Messages.Headers.ErrorDetails)
                           ? Headers[Messages.Headers.ErrorDetails]
                           : null;
            }
        }
        ...
        public string ReturnAddress
        {
            get
            {
                return Headers.ContainsKey(Messages.Headers.ReturnAddress)
                           ? Headers[Messages.Headers.ReturnAddress]
                           : "";
            }
        }
